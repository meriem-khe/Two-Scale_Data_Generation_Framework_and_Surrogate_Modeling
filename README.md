...
To bridge the data scarcity gap, we propose a structured data generation framework using a sequential pipeline based on the **Finite Element Method (FEM)**. This step generates two high-fidelity datasets capturing behaviors at both the **macroscopic** and **microscopic** scales.

#### 2- Noise Injection

To introduce more realism, a post-processing step is performed, which consists of injecting correlated noise into the data.
...
If you use this framework or dataset in your research, please cite our accompanying paper:

> **"Two-Scale Data Generation for Surrogate Model Training"** > *Published in the Journal of Computational Physics (JCP)*

For any questions or collaborations, please feel free to open an issue or reach out via email.
